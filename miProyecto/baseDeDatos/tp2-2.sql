...
--
-- Servidor: localhost
-- Tiempo de generación: 17-11-2020 a las 04:16:05
...
INSERT INTO `PreguntaSeguridad` (`id`, `usuarios_id`, `pregunta`) VALUES
(1, 1, 'que año naciste?'),
(3, 1, 'de que cuadro sos?'),
(5, 1, 'como se llama tu perro?'),
(6, 1, 'color favorito?'),
(7, 1, 'terminaste el colegio?');
...
(2, 'olivia', 'Rozze', 'olirozze@gmail.com', '$2a$10$.IoFw3LudA1gt4/PkfYne.ExcFYLBiv4Dy03Y8pneodytrULg5gVa', '03855957487', '2020-11-18'),
(3, 'agus', 'ramones', 'agus@hper.com', '$2a$10$ZD0nqJ38c9mTLJaJxsX42eRVXvjyyfIXP41JhUPqfRb1q9wtVYSvO', '03855957487', '2020-11-18'),
(4, 'martina', 'sarmiento', 'martina@gmail.com', '$2a$10$YdHg8/wez7hwNF6DibeJIOTosJQ8IyMXpD1bnmWXrUKKiyOQQQS1O', '38559403', '2020-11-12'),
(5, 'agustina', 'Casasnovas', 'aguscasas@gmail.com', '$2a$10$OEfZ9PwQ7SHD/Fhk7Gy2yufPBNT01EO2Y3GK3vNwLHXpDsdPmmXcu', '34759856', '2020-11-03'),
(6, 'ale', 'vivone', 'ale@gmail.com', '$2a$10$Ht4tcsdOT7chNZwutpXCvOA5JUc11eNWTWnVZhX5NF4pFkhu5bUMu', '388405', '2020-11-05'),
(7, 'martu', 'lol', 'martulol@gmail.com', '$2a$10$pwONjsVAuo2LHk0cG2o/u.tzm60Oen7tTcfBe.58Bro9gA2vR70Bi', '3284534', '2020-11-06');
...
--
ALTER TABLE `PreguntaSeguridad`
  ADD CONSTRAINT `preguntaseguridad_ibfk_1` FOREIGN KEY (`usuarios_id`) REFERENCES `PreguntaSeguridad` (`id`);
COMMIT;
